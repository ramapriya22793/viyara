...
export default function FinalCTA() {
  ...
  return (
    <section id="contact" className="py-28 relative overflow-hidden bg-[#162436] text-[#f1f5f9]">
      {/* Visual background ambient gradient meshes */}
      <div className="absolute inset-0 z-0 opacity-40 bg-[radial-gradient(circle_at_center,rgba(22,36,54,0.3)_0%,transparent_70%)]" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[450px] h-[450px] bg-[#3f6a9e]/15 rounded-full blur-[110px]" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-12">
            <div>
              ...
              >
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f1f5f9] via-white to-[#3f6a9e]">
                  Digital Legacy?
                </span>
              </motion.h2>
          ...
          <div className="lg:col-span-7">
            ...
            >
              <div className="absolute top-0 left-0 w-full h-[3px] bg-gradient-to-r from-[#f1f5f9]/30 to-[#3f6a9e]" />
              ...
              {submitted ? (
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] uppercase font-bold tracking-widest text-[#f1f5f9]/50">Subject / Scale Required</label>
                    <input 
                      type="text" 
                      value={formData.subject}
                      onChange={(e) => setFormData({ ...formData, subject: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-xs text-white focus:outline-none focus:border-[#f1f5f9] focus:bg-white/10 transition-all font-light" 
                      placeholder="e.g. Enterprise SaaS &amp; Identity Curation" 
                      required 
                    />
                  </div>
                    ...
                    <div className="relative group/upload">
                      ...
                      <div className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 flex items-center justify-between text-xs text-white/50 focus-within:border-[#f1f5f9] focus-within:bg-white/10 hover:bg-white/10 transition-all font-light">
                        <div className="flex items-center gap-3">
                          <Paperclip size={14} className="text-[#cca353]" />
                  ...
                  <div className="pt-2">
                    <Magnetic range={0.15}>
                      <button 
                        type="submit" 
                        className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-[#f1f5f9] text-[#162436] text-xs font-bold tracking-wider uppercase hover:opacity-90 shadow-md transition-all duration-300 cursor-pointer"
                      >
                        <Send size={12} />
                        Transmit Inquiry
                      </button>

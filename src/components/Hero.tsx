  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="hidden md:block absolute top-[10%] left-[10%] w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] bg-[var(--color-luxury-plum)]/15 rounded-full filter blur-[40px] md:blur-[80px] pointer-events-none"
      />
      <motion.div
        animate={{
          y: [15, -15, 15],
        ...
        className="hidden md:block absolute bottom-[20%] right-[15%] w-[350px] h-[350px] sm:w-[450px] sm:h-[450px] bg-[var(--color-luxury-gold)]/8 rounded-full filter blur-[50px] md:blur-[100px] pointer-events-none"
      />
      <motion.div
        animate={{
          y: [-20, 20, -20],
        ...
        className="hidden md:block absolute top-[40%] right-[30%] w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] bg-[var(--color-luxury-beige)]/5 rounded-full filter blur-[35px] md:blur-[70px] pointer-events-none"
      />
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 w-full flex-grow flex items-center justify-center relative z-10 py-16">
        <div className="flex flex-col items-center justify-center text-center w-full relative">
          ...
          >
            ...
            <span 
              className="text-transparent bg-clip-text bg-[linear-gradient(110deg,#ffffff,45%,#cbd5e1,55%,#ffffff)] bg-[length:200%_100%] animate-[shimmer_4s_infinite]"
              style={{

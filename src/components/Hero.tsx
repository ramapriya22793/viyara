    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 w-full flex-grow flex items-center justify-center relative z-10 py-16">
        <div className="flex flex-col items-center justify-center text-center w-full relative">
          ...
          <div className="absolute -top-6 left-10 text-amber-300 opacity-60 animate-bounce pointer-events-none text-xl">✨</div>
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-[linear-gradient(110deg,#ffffff,45%,#fde047,55%,#ffffff)] bg-[length:200%_100%] animate-[shimmer_4s_infinite]">
